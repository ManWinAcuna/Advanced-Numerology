...
// midnight; when it's empty, falls back to midnight-to-midnight. This is
// purely the BAR's own span - the underlying Personal Day NUMBER still flips
// at real midnight regardless (getPersonalDayRaw, numerology.js - never
// touched here).
...
function render() {
  ...
  // Lucky Number/8 Day/Missing colors are fixed via CSS (.core-chip-lucky/
  // -eightday/-muted) - no longer per-number energy (owner's call
  // 2026-08-31: Lucky Number is always clover green, 8 Day a matching
  // coin gold, regardless of the actual number).
